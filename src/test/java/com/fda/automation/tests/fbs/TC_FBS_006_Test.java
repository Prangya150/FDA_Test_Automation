...
public class TC_FBS_006_Test extends BaseTest {
     ...
     * no matter how long it waits. Now that Mirakl login happens once for the whole suite (see
     * SuiteLoginListener) rather than fresh per test, this check runs on every switch to this tab,
     * not just once before the Mirakl steps.
     */
