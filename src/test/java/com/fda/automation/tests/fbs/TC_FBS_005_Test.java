...
public class TC_FBS_005_Test extends BaseTest {
     ...
     * {@link MiraklOrdersPage#openOrdersMenu} just times out no matter how long it waits. Checks
     * for that and replays the same login (and manual MFA, if re-challenged) used by
     * {@link #loginToMirakl()} before continuing.
     */
